class EC2:
    ...
    def create_security_group(self, group_name, description, vpc_id):
        print("creating security group with name: " + group_name + " for VPC: " + vpc_id)
    ...
    def add_inbound_rule_to_security_group(self, security_group_id):
        print("adding inbound rules to security group: " + security_group_id)
    ...
    def launch_ec2_instance(self, image_id, key_name,min_count,max_count, security_group_id, subnet_id, user_data):
       print("launching" + min_count + "ec2 instances within subnet " + subnet_id )
